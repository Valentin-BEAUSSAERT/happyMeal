function setImage(imagePath, index) {
    ...
    // Animation de fade pour la transition d'image si nécessaire
  ...
  const images = ["../assets/30.webp", "../assets/31.webp", "../assets/32.webp", "../assets/33.webp", "../assets/34.webp", "../assets/42.webp", "../assets/35.webp", "../assets/43.webp", "../assets/36.webp", "../assets/37.webp", "../assets/38.webp", "../assets/39.webp", "../assets/40.webp"];
